...
public class EmbeddedJettyWebSocketChatDemo_old {
    private static final Logger log = LoggerFactory.getLogger(EmbeddedJettyWebSocketChatDemo_old.class);

    public static void main(String[] args) throws Exception {
        new EmbeddedJettyWebSocketChatDemo_old().run();
    }
...
//        context.addServlet(atmosphereServlet, "/socket/*");
